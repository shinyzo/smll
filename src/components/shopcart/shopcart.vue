<template>
  <div class="shopcart">
    ...
    <div class="ball-container">
      <div transition="drop" class="ball" v-for="ball in balls" v-show="ball.show" class="ball">
  ...
  <div class="list-mask" transition="fade" v-show="listShow" @click="hiddenList"></div>
</template>
